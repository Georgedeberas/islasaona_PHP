                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($a['is_published']): ?>
                                        <span class="badge bg-success bg-opacity-10 text-success rounded-pill px-3">Publicado</span>
                                    <?php else: ?>
                                        <span class="badge bg-warning bg-opacity-10 text-warning rounded-pill px-3">Borrador</span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/articles/delete?id=<?= $a['id'] ?>" class="btn btn-sm btn-outline-danger"
