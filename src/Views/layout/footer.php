...
<!-- Mobile Bottom App Bar (Sticky & Modern) -->
<div
    class="fixed bottom-0 left-0 w-full bg-[#ff8c00]/90 backdrop-blur-md border-t border-white/20 z-[9999] md:hidden pb-safe rounded-t-2xl shadow-[0_-4px_20px_rgba(0,0,0,0.15)]">
