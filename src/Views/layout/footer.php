...
<div
    ...
    <div class="flex justify-between items-center px-8 h-[45px]">
        ...
        <a href="<?= $waLink ?>" target="_blank"
            class="flex items-center justify-center w-10 h-10 rounded-full hover:scale-110 transition-transform bg-white/10"
            aria-label="WhatsApp">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#25D366"
                viewBox="0 0 16 16">
                <path
