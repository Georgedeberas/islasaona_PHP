...
<!-- Mobile Bottom Floating Dock (Modern Capsule) -->
<div
    class="fixed bottom-6 left-1/2 transform -translate-x-1/2 w-[90%] max-w-[320px] bg-[#0f172a]/80 backdrop-blur-xl border border-white/10 z-[9999] md:hidden rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
    <div class="flex justify-between items-center px-8 h-[50px]">

        <!-- Inicio -->
        <a href="/" class="flex items-center justify-center text-white/80 hover:text-white transition-opacity"
            aria-label="Inicio">
        ...
        <!-- Tours -->
        <a href="/#tours" class="flex items-center justify-center text-white/80 hover:text-white transition-opacity"
            aria-label="Tours">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                <path
        ...
        <!-- Cuenta -->
        <a href="/contact" class="flex items-center justify-center text-white/80 hover:text-white transition-opacity"
            aria-label="Contacto">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
        ...
        <a href="<?= $waLink ?>" target="_blank"
            class="flex items-center justify-center transition-transform hover:scale-110" aria-label="WhatsApp">
