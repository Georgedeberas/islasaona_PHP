...
<div
    class="fixed bottom-0 left-0 w-full bg-[#ff8c00]/80 backdrop-blur-md border-t border-white/20 z-[9999] md:hidden pb-safe rounded-t-2xl shadow-[0_-4px_20px_rgba(0,0,0,0.15)]">
    <div class="flex justify-between items-center px-12 h-[45px]">

        <!-- Inicio -->
        <a href="/" class="flex items-center justify-center text-white hover:text-white/80 transition-opacity w-10"
            aria-label="Inicio">
        ...
        <!-- Tours (Grid Icon - 4 Squares) -->
        <a href="/#tours"
            class="flex items-center justify-center text-white hover:text-white/80 transition-opacity w-10"
            aria-label="Tours">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                <path
        ...
        <!-- WhatsApp (Green Circle Button with White Icon) -->
        <a href="<?= $waLink ?>" target="_blank"
            class="flex items-center justify-center w-9 h-9 rounded-full bg-[#25D366] hover:scale-110 transition-transform shadow-md"
            aria-label="WhatsApp">
