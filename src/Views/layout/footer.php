...
<div
    class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 z-[9999] md:hidden pb-safe shadow-[0_-5px_15px_rgba(0,0,0,0.03)]">
    <div class="flex justify-between items-center px-8 h-[60px]">

        <!-- Inicio (Home) -->
        <a href="/"
            class="flex flex-col items-center justify-center text-gray-400 function-link hover:text-black transition-colors w-10"
            aria-label="Inicio">
        ...
        <a href="<?= $waLink ?>" target="_blank"
            class="flex items-center justify-center w-10 h-10 bg-[#25D366] text-white rounded-full shadow-md hover:scale-105 transition-transform"
            aria-label="WhatsApp">
